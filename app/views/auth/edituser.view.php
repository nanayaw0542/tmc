        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=ROOT?>/adduser">Add New User</a></li>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title"><h3><b>EDIT USER</b></h3></h3>
          </div>
          <!-- /.card-header -->
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-3">
                  ...
                  <input type="text" class="form-control" name="firstname" id="fname" onkeyup="makeUsername(this);" autofocus placeholder="First Name" id="fname" value="<?=set_value("firstname",$row['Firstname'])?>" autocomplete="off">
               ...
               <div class="col-md-3">
                  ...
                  <input type="text" class="form-control" name="lastname" id="lname" autocomplete="off" onkeyup="makeUsername(this);" placeholder="Last Name" id="lname" value="<?=set_value("lastname",$row['Lastname'])?>">
              ...
              <div class="col-md-3">
                  ...
                  <input type="date" name="dob" value="<?=set_value("dob",$row['DOB'])?>" class="form-control <?=!empty($errors['dob']) ? 'border-danger': ''?>">
