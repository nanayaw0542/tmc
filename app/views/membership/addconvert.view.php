<title>T M C S | Add Convert</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=ROOT?>/manageconverts">Manage Converts</a></li>
              <li class="breadcrumb-item active">Add Convert</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title"><h3><b>ADD A NEW CONVERT</b></h3></h3>
            <div align="">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-xl-3 col-md-6" hidden>
                  ...
                  <input type="text" name="convertid" id="passInput" onchange="makePass(this);" placeholder="Convert Code" class="form-control" readonly>
              </div>
