<title>T M C S | Edit Convert</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit New Convert</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=ROOT?>/addconverts">Add Converts</a></li>
              <li class="breadcrumb-item active">Edit Convert</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title"><h3><b>EDIT A NEW CONVERT</b></h3></h3>
            <div align="">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-xl-3 col-md-6" hidden>
                  ...
                  <input type="text" name="convertid" value="<?=$row["ConvertId"]?>" placeholder="Convert Code" class="form-control" readonly>
              </div>
              ...
              <div class="col-xl-4 col-md-6">
                <label >Inviter's Name</label>
                  <select class="js-example-basic-single form-control <?=!empty($errors['memberid']) ? 'border-danger': ''?>" name="memberid">
                    <?php $members = get_member_by_id($row["MemberId"]);
                    $memberss = $members["Fullname"];
                   ?>
                  <option value="<?=$row["MemberId"]?>" selected><?=$memberss?></option>
           ...
           <div class="col-xl-4 col-md-6">
             ...
             <div class="col-xl-4 col-md-6">
              ...
              <input class="form-control" name="jobdescription" value="<?=$row["JobDescription"]?>" placeholder="Please enter the nature of your work">
            </div>
            <div class="col-xl-4 col-md-6">
                <label>Status</label>
            ...
            <div class="col-xl-4 col-md-6">
                  ...
                  <div class="col-md-12"><br>
                    ...
                    <a href="<?=ROOT?>/manageconverts"><button type="button" class="btn btn-warning">RESET</button></a>
                </div>
