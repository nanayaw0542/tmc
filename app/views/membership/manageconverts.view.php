<title>T M C S | All Converts</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Manage Converts</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=ROOT?>">Home</a></li>
              <li class="breadcrumb-item active">Manage Converts</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><b>ADD, EDIT AND  DELETE CONVERTS</b></h3>
                <a href="<?=ROOT?>/addconvert"><button class="btn btn-primary" style="float: right;">Add New Convert</button></a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th style="font-size: 12px;">Convert ID</th>
                  ...
                  <tr>
                    ...
                    <td style="font-size: 12px;"><?=$user['ConvertId']?></td>
                    <?php 
                    ...
                    <td>
                    <a href="<?=ROOT?>/editconvert&convertid=<?=$user["ConvertId"]?>"><img src="assets/icons/edit-5.svg"></a>
