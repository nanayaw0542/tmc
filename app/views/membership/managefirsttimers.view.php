<title>T M C S | All First Timers</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Manage First Timers</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=ROOT?>">Home</a></li>
              <li class="breadcrumb-item active">Manage First Timers</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><b>ADD, EDIT AND  DELETE FIRST TIMER</b></h3>
                <a href="<?=ROOT?>/addfirsttimers"><button class="btn btn-primary" style="float: right;">Add First Timer</button></a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th style="font-size: 12px;">FirstTimer ID</th>
                    ...
                    <th style="font-size: 12px;">Inviter</th>   
                  ...
                  <tr>
                    <td><?=$i?></td>
                    <td style="font-size: 12px;"><img src="<?=crop($user['Image'],300,$user['Gender'])?>" style="width: 80%;max-width: 50px;" class="rounded-circle shadow"></td>
                    <td style="font-size: 12px;"><?=$user['FirsttimersId']?></td>
                    <?php 
                    ...
                    <?php 
                      $getministry = get_member_by_id($user['MemberId']);
                      if (empty($getministry)) {
                        $ministry = "N/A";
                      }
                      else{
                      $ministry = $getministry["Fullname"];
                    }
                     ?>
                    ...
                    <td>
                    <a href="<?=ROOT?>/editfirsttimer&firsttimerid=<?=$user["FirsttimerId"]?>"><img src="assets/icons/edit-5.svg"></a>
                    <a href="<?=ROOT?>/deletemember&memberid=<?=$user["FirsttimerId"]?>"><img src="assets/icons/delete1.svg"></a>
                  </td>
                  </tr>
                 <?php } ?>
                 <?php endif; ?>
