<title>T M C S | Add Ministry</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=ROOT?>/manageministrys">Manage Ministry</a></li>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title"><h3><b>ADD A NEW MINISTRY</b></h3></h3>
          </div>
          <!-- /.card-header -->
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-3">
                  ...
                  <input type="text" name="ministryid" placeholder="Usercode" id="passInput" class="form-control" value="<?=set_value("ministryid")?>" readonly>
              ...
              <div class="col-md-3">
                  ...
                  <input type="text" class="form-control" name="ministryname" autofocus placeholder="Ministry Name" value="<?=set_value("ministryname")?>" autocomplete="off">
              ...
              <div class="col-md-3">
                  ...
                  <input type="text" class="form-control" name="ministryhead" autofocus placeholder="Ministry Head" value="<?=set_value("ministryhead")?>" autocomplete="off">
