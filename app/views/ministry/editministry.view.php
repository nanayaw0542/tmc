<title>T M C S | Edit Ministry</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=ROOT?>/addministry">Add Ministry</a></li>
              <li class="breadcrumb-item active">Edit Ministry</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title"><h3><b>EDIT MINISTRY</b></h3></h3>
          </div>
          <!-- /.card-header -->
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-3">
                  ...
                  <input type="text" class="form-control" name="ministryname" autofocus placeholder="Ministry Name" value="<?=set_value("ministryname",$row["MinistryName"])?>" autocomplete="off">
              ...
              <div class="col-md-3">
                  ...
                  <input type="text" class="form-control" name="ministryhead" autofocus placeholder="Ministry Head" value="<?=set_value("ministryhead",$row["MinistryHead"])?>" autocomplete="off">
